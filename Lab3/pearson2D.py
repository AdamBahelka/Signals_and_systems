...
def fft2D(direction, re, im):
    # Get the shape of the real part of the image
    '''YOU HAVE TO IMPLEMENT THE BODY OF THIS FUNCTION YOURSELF'''
    '''YOU CAN USE THE fft1D() FUNCTION ABOVE'''

    # Perform 1D FFT on each row of the real and imaginary parts of the image
    '''YOU HAVE TO IMPLEMENT THE BODY OF THIS FUNCTION YOURSELF'''
    '''YOU CAN USE THE fft1D() FUNCTION ABOVE'''

    # Initialize arrays to hold the real and imaginary parts of the column transform
    '''YOU HAVE TO IMPLEMENT THE BODY OF THIS FUNCTION YOURSELF'''
    '''YOU CAN USE THE fft1D() FUNCTION ABOVE'''

    # Perform 1D FFT on each column of the real and imaginary parts of the image
    '''YOU HAVE TO IMPLEMENT THE BODY OF THIS FUNCTION YOURSELF'''
    '''YOU CAN USE THE fft1D() FUNCTION ABOVE'''
